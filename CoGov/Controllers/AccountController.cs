    ...
    public class AccountController : ApplicationController
    {
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    if (emailClaim != null)
                    {
                        ...
                        var user = new ApplicationUser { UserName = emailClaim.Value, Email = emailClaim.Value, NameFirst = Names[0], NameLast = Names.Last(), TimeStamp = DateTime.UtcNow };
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, NameFirst = "J.", NameLast = "Doe", TimeStamp = DateTime.UtcNow };
